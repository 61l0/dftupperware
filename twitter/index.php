...
class ezTweet {
   ...
   // Your Twitter App Consumer Key
	private $consumer_key = "0oYao0a3WGOvoRV9iFuy4tpkU";//'YOUR_CONSUMER_KEY';

	// Your Twitter App Consumer Secret
	private $consumer_secret = "dlQsakNWTGhBL0sk9TYxq6SbjDiA46uQIgxWeo57MGEToQLqBN";//'YOUR_CONSUMER_SECRET';

	// Your Twitter App Access Token
	private $user_token = "4504719435-o9Y5CULxjvlp6JxcDTrcTqM3nLN567vXr8HsPT2";//'YOUR_ACCESS_TOKEN';

	// Your Twitter App Access Token Secret
	private $user_secret = "C3nPfGqLBVxqZG1Nl9sasS2KujepM5q1YeG0hGQ89VTgg";//'YOUR_ACCESS_TOKEN_SECRET';
